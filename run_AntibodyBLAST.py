...
parser.add_argument('--db_pickle', help='Pickle file for database')
parser.add_argument('--target_pickle', help='Pickle file for target')
...
import pickle
dbfile = open(args.db_pickle, "rb")
updated_ppi_list_db = pickle.load(dbfile)
targetfile = open(args.target_pickle, "rb")
updated_ppi_list_target = pickle.load(targetfile)
...
#
import pickle
db = open(output_dir+"/database.blast.pkl", "wb")
